defmodule BooksApi.StoreTest do
  ...
  describe "books" do
    ...
    @invalid_attrs %{authors: nil, desription: nil, isbn: nil, price: nil, title: nil}
    ...
    test "create_book/1 with valid data creates a book" do
      valid_attrs = %{authors: [], desription: "some desription", isbn: "some isbn", price: 120.5, title: "some title"}

      assert {:ok, %Book{} = book} = Store.create_book(valid_attrs)
      assert book.authors == []
      assert book.desription == "some desription"
    ...
    test "update_book/2 with valid data updates the book" do
      book = book_fixture()
      update_attrs = %{authors: [], desription: "some updated desription", isbn: "some updated isbn", price: 456.7, title: "some updated title"}

      assert {:ok, %Book{} = book} = Store.update_book(book, update_attrs)
      assert book.authors == []
      assert book.desription == "some updated desription"
